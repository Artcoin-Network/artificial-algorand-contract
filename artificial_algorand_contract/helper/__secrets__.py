...
ACCOUNT1_MNEMONIC = secret.get("REACT_APP_TEST_ACCOUNT1_MNEMONIC")
ACCOUNT2_MNEMONIC = secret.get("REACT_APP_TEST_ACCOUNT2_MNEMONIC")
ACCOUNT3_MNEMONIC = secret.get("REACT_APP_TEST_ACCOUNT3_MNEMONIC")
